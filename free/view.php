<?php
    ...
    include $_SERVER['DOCUMENT_ROOT'] . "/mypage0420/free/lib/free_func.php";
...
<html lang="ko" dir="ltr">
	<head>
		...
		<link rel="stylesheet" type="text/css"
		      href="http://<?= $_SERVER['HTTP_HOST'] ?>/mypage0420/free/css/greet.css">
	...
	<body>
		...
		<section>
			...
			");
                ...
                include $_SERVER['DOCUMENT_ROOT'] . "/mypage0420/main_img_bar.php"; ?>
			<div id="wrap">
				<div id="content">
					<div id="col2">
						<div id="title"><h3>COMMUNITY</h3></div>
						<div class="clear"></div>
