...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css"
		      href="http://<?= $_SERVER['HTTP_HOST'] ?>/mypage0420/notice/css/notice.css">
		<script src="http://<?= $_SERVER['HTTP_HOST'] ?>/mypage0420/notice/js/notice.js"></script>
	...
	<body>
        ...
        <?php include_once $_SERVER['DOCUMENT_ROOT'] . "/mypage0420/db/db_connect.php";
