...
<head>
    ...
    <link rel="stylesheet" href="http://<?=$_SERVER["HTTP_HOST"]?>/mypage0420/login/css/login.css?after">
    <script src="https://code.jquery.com/jquery-1.12.4.min.js"></script>
    <script src="http://<?=$_SERVER["HTTP_HOST"]?>/mypage0420/login/js/login.js"></script>
