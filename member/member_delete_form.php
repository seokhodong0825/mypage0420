...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://<?=$_SERVER["HTTP_HOST"]?>/mypage0420/member/css/member.css?after">
    <script src="https://code.jquery.com/jquery-1.12.4.min.js"></script>
    <script src="http://<?=$_SERVER["HTTP_HOST"]?>/mypage0420/member/js/member.js" defer></script>
